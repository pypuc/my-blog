...
var _fetchImagesJs = require("./api/fetchImages.js");
let currentPage = 1;
let currentQuery = '';
...
async function onSearch(e) {
    ...
    gallery.innerHTML = '';
    try {
        const images = await (0, _fetchImagesJs.fetchImages)(currentQuery, currentPage);
        renderImages(images);
...
},{"./api/fetchImages.js":"j5VVf"}],"j5VVf":[function(require,module,exports,__globalThis) {
